<?php $utils = app('App\Services\UtilsService'); ?>
...
@section('page_header')
    <div class="container-fluid">
        ...
        <a href="{{ route('voyager.'.$dataType->slug.'.update_number_products') }}" class="btn btn-primary">
            <i class="fas fa-sync-alt"></i> 
            <span class="hidden-xs">{{ __('Nombre de produits') }}</span>
        </a>        

...
@section('page_header')
    <div class="container-fluid">
        ...
        @can('add', app($dataType->model_name))
            <a href="{{ route('voyager.'.$dataType->slug.'.add', $storeId) }}" class="btn btn-success btn-add-new">
    ...
    <div class="page-content browse container-fluid">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <!-- ### Store ### -->
                <?php 
                    $storeNameSingular = $storeDataType->display_name_singular;
                    $storeIcon = $storeDataType->icon;
                ?>
                <div class="panel">                            
                    <div class="panel-heading">
                        <h3 class="panel-title">
                            <i class="{{ $storeIcon }}"></i> {{ $storeNameSingular }}
                        </h3>
                    ...
                    <div class="panel-body">
                        <div class="form-horizontal">
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    <p class="form-control-static"> {{ $storeData->name }}</p>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-2 control-label">Adresse :</label>
                                <div class="col-md-10">
                                    <p class="form-control-static"> {{ $storeData->address }}</p>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-2 control-label">Complément :</label>
                                <div class="col-md-10">
                                    <p class="form-control-static"> {{ $storeData->address_2 }}</p>
                                </div>
                            </div>
                        </div>    
                    </div>    

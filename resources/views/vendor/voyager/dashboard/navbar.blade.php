    ...
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <ol class="breadcrumb hidden-xs">
                ...
                @else
                    <li class="active">
                        <a href="{{ route('voyager.dashboard')}}"><i class="voyager-compass"></i> {{ __('voyager.generic.dashboard') }}</a>
                    </li>
                @endif
        ...
        <ul class="nav navbar-nav navbar-right">
            <li class="dropdown profile">
                <div class="float-left aufi-nav-site">
                    <a href="{{ route('index') }}" class="btn btn-success" target="_blank" style="margin-top: 15px;" >
                        <i class="fas fa-external-link-alt"></i>
                        <span class="">{{__('Acceder au site') }}</span>
                    </a>
                </div>  

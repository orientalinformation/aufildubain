...
class VoyagerSlidesMods extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        // find DataType
        $dataType = DataType::where('name', 'slide_shows')->first();
        
        if ($dataType) {
            // delete btn_name field
            DataRow::where('data_type_id', $dataType->id)->where('field', 'btn_name')->first()->delete();

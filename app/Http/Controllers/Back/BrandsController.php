...
* 
*/
class BrandsController extends VoyagerBreadController
{
    ...
    public function index(Request $request)
    {
        ...
        $orderBy = $request->get('order_by', 'ord');
        ...
        if (strlen($dataType->model_name) != 0) {
            ...
            $dataTypeContent = call_user_func([DB::table($dataType->name), $getter], $limit);
            $model = false;
        }
    ...
    public function updateNumOfProducts()
    {
        $this->utils->calculateProductOfBrand();

        return back()->with([
            'message'    => __('Mise à jour réussie'),
            'alert-type' => 'success',
        ]);
    }
}